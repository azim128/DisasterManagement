...
import { adminRouters, authRouters, crisisRouters, donationRouters, inventroyRouters, purchaseRouters, userRouters, volunteerRouters } from "./routes/index.js";
...
app.use("/api/v1/purchase", purchaseRouters);
